...
public class House 
    ...
    public House(int length, int width, int lotLength, int lotWidth) {
        //super keyword is used for access property of building class
        super(length, width, lotLength, lotWidth);
        this.mOwner = null;
        this.mPool = false;
    }

    //Creating another constructor with owner name
    ...
    //Creating another constructor with owner name and pool status
